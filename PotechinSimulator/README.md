...
This project is one of the two independent source folders in the [repository overview](../README.md). You can also [open the Cook–Mertz simulator](https://therisnow.github.io/amortized-branching-program-simulator/cook-mertz/).
